  ...
  const clients = await Client.insertMany([
    {
      ...
      lastCleanedDate: subDays(now, 5).toISOString(), dateAdded: subDays(now, 90).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: subDays(now, 10).toISOString(), dateAdded: subDays(now, 120).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: subDays(now, 28).toISOString(), dateAdded: subDays(now, 60).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: subDays(now, 12).toISOString(), dateAdded: subDays(now, 150).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: subDays(now, 6).toISOString(), dateAdded: subDays(now, 45).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: null, dateAdded: subDays(now, 30).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: subDays(now, 4).toISOString(), dateAdded: subDays(now, 75).toISOString(), createdBy: admin._id,
    },
    {
      ...
      lastCleanedDate: subDays(now, 45).toISOString(), dateAdded: subDays(now, 180).toISOString(), createdBy: admin._id,
    },
  ]);
