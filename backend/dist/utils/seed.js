...
const seed = async () => {
    ...
    const clients = await Client_model_1.default.insertMany([
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 5).toISOString(), createdBy: admin._id,
        },
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 10).toISOString(), createdBy: admin._id,
        },
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 28).toISOString(), createdBy: admin._id,
        },
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 12).toISOString(), createdBy: admin._id,
        },
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 6).toISOString(), createdBy: admin._id,
        },
        {
        ...
        },
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 4).toISOString(), createdBy: admin._id,
        },
        {
            ...
            lastCleanedDate: (0, date_fns_1.subDays)(now, 45).toISOString(), createdBy: admin._id,
        },
    ]);
    ...
    invoiceData.push({
        ...
        dueDate: (0, date_fns_1.subDays)(now, 5).toISOString(), status: "unpaid", paidDate: null, notes: "",
    }, {
        invoiceNumber: "SC-0102", client: clients[1]._id.toString(),
        clientName: clients[1].name, amount: clients[1].pricePerVisit,
        dueDate: (0, date_fns_1.subDays)(now, 10).toISOString(), status: "unpaid", paidDate: null, notes: "",
    }, {
        invoiceNumber: "SC-0103", client: clients[3]._id.toString(),
        clientName: clients[3].name, amount: clients[3].pricePerVisit,
        dueDate: (0, date_fns_1.subDays)(now, 12).toISOString(), status: "unpaid", paidDate: null, notes: "",
    });
