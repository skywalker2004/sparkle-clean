...
export declare const markUnpaid: (req: AuthRequest, res: Response) => Promise<void>;
export declare const recordCleaning: (req: AuthRequest, res: Response) => Promise<Response<any, Record<string, any>>>;
